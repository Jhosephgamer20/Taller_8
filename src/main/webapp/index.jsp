...
<head>
    ...
    <!-- FAVICON -->
    <link rel="icon" type="image/x-icon" href="./img/Formulario_de_Contacto.png">
    <!-- CSS -->
    <!-- bootstrap css/icons -->
...
<!-- login form -->
    ...
    <img class="mb-4" src="./img/Formulario_de_Contacto.png" alt="MY APP" width="100">
    ...
    <label for="floatingPassword">Contraseña:</label><br>
        ...
        <div id="register">
            <a href="User">Registrarse.</a><br>
            <a href="Categories">Registro Categoria.</a><br>
            <a href="Products">Registro Producto.</a>
        </div>
